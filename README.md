...
_In this tutorial we switch over from VS Code to the browser based Babylon playground, located at:
[playground.babylonjs.com](https://playground.babylonjs.com/). However if you want to stay in VS Code I recommend following the [dev.to Blog post](https://dev.to/azure/build-a-web-vr-game-with-javascript-using-the-babylonjs-framework-aek)</br>
Additionally in the [Helpful Links](https://github.com/cassieview/Build-First-Web-VR-Game-Absolute-Beginner/blob/master/README.md#helpful-links) I provide links to the github repo for the typescript starter projet and the completed game._
